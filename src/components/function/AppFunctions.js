...
import InternetMail from '../../assets/internet-mail.png'
...
export function handleDoubleClickiframe(name, setOpenProjectExpand, setProjectUrl, setBackTrackIe, setForwardTrackIe) {
  ...
  switch(name) {
    ...
    break;
        ...
        setProjectUrl('https://safwansabir.github.io/AI_chatbot/'); 
        setBackTrackIe(prev => [...prev, 'https://safwansabir.github.io/AI_chatbot/']);
    break;

        setProjectUrl('https://safwansabir.github.io/3d_book/'); 
