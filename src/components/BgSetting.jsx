...
import bg3 from '../assets/nature.gif'
...
import bg11 from '../assets/swordBG.gif'
...
function BgSetting() {
  ...
  const [ localtheme, setLocalTheme ] = useState(() => {
    ...
    return prevTheme? prevTheme : '#008081'
  })
  ...
  const { 
    ...
    deleteTap,
      ...
      const colorOptions = [
        ...
        { value: 4, label: 'Nature', color: '#008081', image: bg3, barColor: '#008081'},
        ...
        { value: 12, label: 'Abandoned Yard', color: '#828890', image: bg11, barColor: '#4a4a4a'},
